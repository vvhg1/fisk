...
void *leader_start_func(uint16_t keycode) {
    switch (keycode) {
        //     // if keycode is a number, get the number
        // case KC_1 ... KC_9:
...
// void *numbers_game(uint16_t keycode) {
//     switch (keycode) {
//         case KC_1 ... KC_0:
//             myint = keycode - KC_0;
//             if (numberofiterationsforleader < 100) {
//                 numberofiterationsforleader = numberofiterationsforleader * 10 + myint;
//             } else {
//                 numberofiterationsforleader = 0;
//                 return NULL;
//             }
//             return numbers_game;
//         case KC_I:
//             if (numberofiterationsforleader > 0) {
//                 // tap up sequencenumber times
//                 for (int i = 0; i < numberofiterationsforleader; i++) {
//                     tap_code(KC_UP);
//                     wait_ms(1);
//                 }
//             }
