 ...
 */
    ...
    _______, EURO_SYM, KC_LEFT, KC_DOWN , KC_RIGHT,_______, _______,                                     _______,  KC_0,      KC_1,    KC_2,    KC_3,  KC_PLUS,  S(KC_4),
    _______, _______,     Cut,    Copy,  Redo,   Paste,               _______,_______,        _______, _______,    KC_PSLS,   KC_4,    KC_5,    KC_6,  DotC,   _______,
